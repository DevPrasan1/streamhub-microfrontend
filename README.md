...
This project allows you to confidently discuss:

### Architecture

* Why Module Federation?
* Why three MFEs?
* Host vs. Remote responsibilities.
* Why business-domain separation?

### State Management

* Why Zustand?
* What belongs in global state vs. local state?
* Why the Host owns authentication?
...
* Security rules (important to mention in interviews).
